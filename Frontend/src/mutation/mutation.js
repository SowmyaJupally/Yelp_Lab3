...
const searchRestuarantMutation = gql`
  mutation searchRestaurant($name: String) {
...
mutation placeOrder($email: String,$itemId:String,$quantity:Int, $price:Int) {
  placeOrder(email: $email,itemId:$itemId,quantity:$quantity,price:$price) {
